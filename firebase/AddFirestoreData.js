...
const AddFirestoreData = () => {
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            {isAdding && <Text className="text-md font-medium text-green-400" >Adding document...</Text>}
            {error && <Text className="text-md font-medium text-green-400" >Error adding document: {error.message}</Text>}
